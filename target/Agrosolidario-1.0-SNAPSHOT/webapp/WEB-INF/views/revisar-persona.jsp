...
<body>
    ...
    <section class="aceptados">
        <h1 class="aceptados__title">Personas que aceptaron la oferta:</h1>
        ...
        <article class="aceptados-card">
            <div class="aceptados-card__left">
                ...
                <!-- Antes: selec-persona.html -->
                <a href="${pageContext.request.contextPath}/selec-persona.html"
                   class="btn-dark aceptados-card__btn">Seleccionar</a>
            </div>
        ...
        <div class="aceptados-nav">
            <!-- Antes: lista-oferta.html -->
            <a href="${pageContext.request.contextPath}/app/dueno/lista-oferta"
               class="btn-dark aceptados-nav__btn">Volver</a>

            <!-- Ajusta esta ruta cuando definas la navegación real -->
            <a href="${pageContext.request.contextPath}/app/dueno/revisar-persona"
               class="btn-dark aceptados-nav__btn">Siguiente</a>
        </div>
    </section>
