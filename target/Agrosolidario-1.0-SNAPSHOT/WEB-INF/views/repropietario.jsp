...
<!-- FORMULARIO COMPLETO -->
<form method="post"
      action="${pageContext.request.contextPath}/app/auth/registro-propietario"
            ...
            <section class="step" id="step-2">
                <div class="card">
                    ...
                    <div class="grid-2">
                        ...
                        <div>
                            <label>Ubicación:</label>
                            <input type="text" name="ubicacion_finca" value="" />
                        </div>

                        <div>
                            <label>Tamaño o extensión (hectáreas)</label>
                            <input type="text" name="tamano_hectareas" />
                        </div>

                        <div>
                            <label>Tipo de producción:</label>
                            <input type="text" name="tipo_produccion" />
                        </div>
                    </div>

                    <label style="margin-top:12px;">Descripción de la finca</label>
                    <textarea name="descripcion_finca"></textarea>
                </div>
            </section>
                ...
                <div class="card">
                    ...
                    <div class="upload-row">
                        ...
                        <div class="upload-box">
                            ...
                            <input id="doc-id" class="file-input" type="file" name="doc_identificacion"
                        ...
                        <div class="upload-box">
                            ...
                            <input id="doc-prop" class="file-input" type="file" name="doc_propiedad"
                                   accept=".pdf,.jpg,.jpeg,.png" />
