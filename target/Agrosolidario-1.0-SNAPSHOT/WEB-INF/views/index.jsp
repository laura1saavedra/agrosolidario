...
<header>
    ...
    <nav>
        ...
        <a href="${pageContext.request.contextPath}/LoguearseServlet">Inicio de sesión</a>
...
<section class="primer-mockup">
    ...
    <a href="${pageContext.request.contextPath}/app/auth/registro" class="boton-empieza">¡Empieza ahora!</a>
...
<section class="seccion-accesos">
    ...
    <div class="columna">
        ...
        <div class="tarjeta">
            ...
            <a href="${pageContext.request.contextPath}/app/auth/inicio-sesion" class="tarjeta-button">¡Empieza ahora!</a>
        </div>
    </div>
    ...
    <div class="columna">
        ...
        <div class="tarjeta">
            ...
            <a href="${pageContext.request.contextPath}/app/auth/registro" class="tarjeta-button">¡Empieza ahora!</a>
        </div>
    </div>
...
<section class="seccion-info">
    ...
    <div class="contenedor-info">
        ...
        <div class="imagen-info">
            <img src="${pageContext.request.contextPath}/assets/imagenes/info-agrosolidario.png"
                 alt="Personas trabajando en cultivo">
        </div>
    ...
    <a href="${pageContext.request.contextPath}/app/auth/registro" class="boton-unete">¡Únete ya!</a>
